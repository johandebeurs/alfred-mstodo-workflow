...
def mock_default_reminder_time(mocker):
	...
	preference
	"""
	mocker.patch('mstodo.models.preferences.Preferences.reminder_time', new=_default_reminder_time)
...
def mock_default_reminder_today_offset(mocker):
	...
	"""
	mocker.patch('mstodo.models.preferences.Preferences.reminder_today_offset', new=_default_reminder_today_offset)
...
def mock_2_hour_reminder_today_offset(mocker):
	...
	"""
	mocker.patch('mstodo.models.preferences.Preferences.reminder_today_offset', new=time(2, 0, 0))
...
def mock_disabled_reminder_today_offset(mocker):
	...
	"""
	mocker.patch('mstodo.models.preferences.Preferences.reminder_today_offset', new=None)
...
def mock_default_explicit_keywords(mocker):
	...
	"""
	mocker.patch('mstodo.models.preferences.Preferences.explicit_keywords', new=False)
...
def mock_disabled_explicit_keywords(mocker):
	...
	"""
	mocker.patch('mstodo.models.preferences.Preferences.explicit_keywords', new=True)
...
def mock_disabled_automatic_reminders(mocker):
	...
	"""
	mocker.patch('mstodo.models.preferences.Preferences.automatic_reminders', new=False)
...
def mock_default_list_inbox(mocker):
	...
	"""
	mocker.patch('mstodo.models.preferences.Preferences.default_list_id', new=None)
...
def mock_default_list_single_word_list(mocker):
	...
	"""
	mocker.patch('mstodo.models.preferences.Preferences.default_list_id', new=1)
...
def mock_default_list_invalid_list(mocker):
	...
	"""
	mocker.patch('mstodo.models.preferences.Preferences.default_list_id', new=8)
